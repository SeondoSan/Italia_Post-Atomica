...
**Fonte di riferimento rapido per i fatti dell'ambientazione.**
...
| Capitale pontificia | Parthenope Vaticana, Monte Orlando (Gaeta) |
| Città distrutte | Milano, Torino, Venezia, Genova, Bologna, Roma, Napoli |
| Isolamento | Totale. Valichi contaminati, Mediterraneo aperto letale. Nessuno entra, nessuno esce |
...
| 2077-2090 | Il Silenzio. Papa isolato a Gaeta, nave dei Pirati al largo dell'Albania |
| 2090-2100 | **Tabula Rasa**. Distruzione della memoria materiale |
| 2100-2150 | Consolidamento. Comunità attorno ai castelli, Parthenope prende forma |
| 2150-2250 | Egemonia. Nessun rivale. Comparsa dei Palustres (~2180) |
| 2250-2293 | Guerra permanente coi Pirati. Prima Crociata 2252-2255 |
...
| Comunità del rifugio | ~150, mai uscita |
| Residenti originari dei rifugi | 40.000-50.000 |

Cifre militari e demografiche di dettaglio: `[CIFRA INDICATIVA - MODIFICABILE PER ESIGENZE DI TRAMA]`.
...
**Pirati** — discendenti di una nave da crociera a tema piratesco sopravvissuta al 2077. Fase horror a bordo (2077-2090), periodo balcanico (2090-2200), navigazione a Ovest (2200-2250), arrivo e incidente con le guardie pontificie (2250). Etica: *non si lascia indietro nessuno*.

**I Custodi** — sigillati sotto Castel Sant'Angelo dal 2077. **Non escono prima del Punto Zero.** Al 2293 sono ancora cattolici: nessuno scisma, nessun nome, nessun simbolo. La Chiesa Custodiale nasce dopo l'uscita.

**Terre del Nord** — non è una fazione. Comunità piccole, frammentate, senza organizzazioni formali.

**Brigantaggio alpino** — bande di poche persone, senza coordinamento.

**Non esistono al 2293**: Confederazione del Mare Dolce, Lega dei Navigli, Fratellanza Alpina, città-stato, qualunque resistenza organizzata.
...
| Condizione | **Non esistono Palustres liberi.** Nati in cattività, dipendenti dalla nascita |
...
## Contaminazione Mantenuta

La Chiesa alimenta **deliberatamente** la radioattività di tre aree, rilasciandovi Palustres allo Stadio 4:

- **Arcipelago Centrale** — per isolare il rifugio e tenere lontani gli esterni
- **Margini esterni dell'arco alpino** — per rendere impraticabile il confine
- **Mediterraneo al largo** — per impedire contatti via mare

Per la popolazione sono semplicemente terre maledette.
...
| Artifex | Bambini sottratti alla nascita, dichiarati nati-morti (~15-20/anno). Isolati nei monasteri, ignari della propria origine. Abati nominati da Roma |
| Alfabetizzazione | Clero, Famiglie, rari autodidatti. La nobiltà civile spesso no |
| Mobilità sociale | Praticamente assente. Unica via: farsi monaco |
| Demografia | Famiglie numerose, alta mortalità infantile |
| Calendario | Il clero conta dal **2077 come anno zero**. La popolazione non conta gli anni: solo "prima" e "dopo la Punizione" |

---

## Religione

- **Cattolicesimo integro** nella dottrina, restaurato nella forma: più solenne, più cerimoniale, più gerarchico
- **Mai abolito né ridimensionato** politicamente. È una continuità, non una reintroduzione
- **Bibbia inaccessibile ai laici.** Leggerla è precluso, interpretarla è eresia
- **Nessun culto alternativo** esiste o è concepibile
- **Dottrina della Punizione**: l'umanità ha peccato di superbia, Dio ha distrutto il suo mondo
- **Benedizioni energetiche**: propaganda consapevole. Stabiliscono il diritto d'uso, non un potere magico
...
| Scambi ordinari | Baratto |
| Tributi | Riscossi ovunque, con regolarità variabile e all'occorrenza con la forza |
| Non esiste | Nessuna banca, nessun credito, nessun commercio estero, nessuna crescita |

---

## Tecnologia

- **Apartheid tecnologico**: due livelli, popolazione medievale e Chiesa atomica, **nessun gradino intermedio**
...
- **Nessun esperimento sociale è stabilito.** Non sono esclusi, semplicemente non ce ne sono ancora
...
| Innocenzo X, Clemente XV, Romualdo Savellini | Papa Aeternus Primus (prebellico: Clemente XVI) |
