...
- ✅ "Antonio Loredan" → `../06-Luoghi/06.4-altri-centri.md#figure-di-rilievo` (1 occorrenza)
...
- ✅ "Custodi" → `../05-Fazioni/05.6-custodi-tempo.md` (3 occorrenze)
...
**Collegamenti implementati**:
- ✅ "Custodi della Dottrina" → `../05-Fazioni/05.1-stato-pontificio.md#guardie-vaticane` (6 occorrenze)
- ✅ "Figli del Silenzio" → `../05-Fazioni/05.1-stato-pontificio.md#le-ombre-del-verbo` (1 occorrenza)
- ✅ "Fratellanza Alpina" → `../05-Fazioni/05.4-fratellanza-alpina.md` (10 occorrenze)
- ✅ "Palustres" → `../07-Creature/07.2-palustres.md` (10 occorrenze)
...
- ✅ "Repubblica Serenissima di Venezia" → `../06-Luoghi/06.4-altri-centri.md` (4 occorrenze)
...
**Collegamenti implementati**:
- ✅ "Fratellanza Alpina" → `../05-Fazioni/05.4-fratellanza-alpina.md` (10 occorrenze)
- ✅ "Palustres" → `../07-Creature/07.2-palustres.md` (12 occorrenze)
...
- ✅ "Custodi della Dottrina" → `../05-Fazioni/05.1-stato-pontificio.md#guardie-vaticane` (5 occorrenze)
...
- ✅ "Crisi dei Palustres" → `../10-Eventi/10.2-conflitti.md#crisi-dei-palustres-2289-2290` (1 occorrenza)

### ✅ 08.4-arsenali-perduti.md (COMPLETATO)
**Collegamenti implementati**:
- ✅ "Custodi" → `../05-Fazioni/05.6-custodi-tempo.md` (5 occorrenze)
...
- ✅ "Palustres Abissali" → `../07-Creature/07.2-palustres.md#palustres-abissali` (2 occorrenze)
...
- ✅ "Figli del Silenzio" → `../05-Fazioni/05.1-stato-pontificio.md#le-ombre-del-verbo` (2 occorrenze)
...
- `../07-Creature/07.2-palustres.md`: Aggiungere collegamenti a:
  ...
  - "Palustres Abissali" → Assicurarsi che questa sottosezione esista e sia collegata da 08.4
...
- `../06-Luoghi/06.4-altri-centri.md`: Aggiungere collegamenti a:
  - "Fornaci di Murano" → `../08-Tecnologia/08.2-armamenti-moderni.md#le-fornaci-di-murano-repubblica-di-venezia`
  - "Palustres Abissali" → `../07-Creature/07.2-palustres.md#palustres-abissali`
