...
- `../01.0-indice-principale.md` → sezione Geografia
...
- `../06-Luoghi/06.4-altri-centri.md` (Repubblica Serenissima)
...
- `03.3-regioni-nord.md#grande-palude` (La Alto Mare Dolce)
...
- `../05-Fazioni/05.3-lega-navigli.md` (Lega dei Navigli)
- `../05-Fazioni/05.4-fratellanza-alpina.md` (Fratellanza Alpina)
- `../07-Creature/07.2-palustres.md` (Alto Mare Dolce, come habitat dei Palustres)
- `03.2-grande-guerra.md` (Cratere di Milano, Cratere di Torino)
- `../05-Fazioni/05.4-fratellanza-alpina.md` (Alpi Irradiate)
- `../06-Luoghi/06.4-altri-centri.md` (Repubblica Serenissima di Venezia, Venezia Sommersa)
...
- `../07-Creature/07.2-palustres.md` → riferimento alla Alto Mare Dolce
- `../07-Creature/07.5-altre-creature.md` → riferimento alle regioni del Nord
- `03.0-geografia-panoramica.md` → collegamenti a Rete dei Navigli, Alpi Irradiate, Terra dei Laghi, Alto Mare Dolce
- `03.1-morfologia-generale.md` → collegamenti a Pianura Padana, Alto Mare Dolce, Mare Interno Lombardo, Pilastri Alpini
...
- `03.5-regioni-sud.md` (Regioni del Sud)
- `../05-Fazioni/05.1-stato-pontificio.md` (Stato Pontificio)
- `../05-Fazioni/05.6-custodi-tempo.md` (Custodi)
...
- "Alto Mare Dolce" (Nord)
  - **Menzionato in**: `03.0-geografia-panoramica.md`, `03.1-morfologia-generale.md`, `03.3-regioni-nord.md`, `../07-Creature/07.0-creature-panoramica.md`, `../07-Creature/07.1-mutazioni-panoramica.md`, `../07-Creature/07.2-palustres.md`, `../07-Creature/07.5-altre-creature.md`
...
- "Repubblica Serenissima di Venezia" / "Venezia Sommersa"
  - **Menzionato in**: `03.1-morfologia-generale.md`, `03.3-regioni-nord.md`, `../06-Luoghi/06.4-altri-centri.md`
...
1. In `03.0-geografia-panoramica.md`: Collegamenti a "Alto Mare Dolce", "Zona Morta di Roma", "Arcipelago Campano", "Alpi Irradiate" ✅
...
3. In `03.1-morfologia-generale.md`: Collegamenti a "Grande Frattura", "Repubblica Serenissima", "Alto Mare Dolce", "Spirale Siciliana" ✅
4. In `03.3-regioni-nord.md`: Collegamenti a "Alto Mare Dolce" e altre formazioni geografiche del Nord ✅
...
1. Da `../07-Creature/07.2-palustres.md` a `03.3-regioni-nord.md#grande-palude` per completare il riferimento all'habitat
...
5. Da `../06-Luoghi/06.4-altri-centri.md` a `03.3-regioni-nord.md` per riferimenti alla geografia lagunare
...
2. **Interconnessione tra geografia e fazioni**:
   - Le caratteristiche geografiche influenzano direttamente le societa che vi si sviluppano
