...
- `../01.0-indice-principale.md` → sezione Eventi Recenti
...
- `../07-Creature/07.2-palustres.md` → riferimento alla "Crisi delle Acque Mutate"
...
- "Sistema di purificazione Palustres" (compare 2 volte)
...
- "Custodi" (compare 18 volte)
- "Palustres" (compare 6 volte)
...
### Personaggi Chiave
- "Alessandra Morvillo" (leader dei Custodi)
...
- "Palustres"
  ...
  - **File principale**: `../07-Creature/07.2-palustres.md`
  - **Stato collegamenti**: Da implementare - mancano collegamenti in tutti i file
...
2. **Fazioni principali**, da collegare in tutti i file:
   - "Custodi" → `../05-Fazioni/05.6-custodi-tempo.md`
...
1. Da file esterni verso eventi del modulo 10:
   ...
   - `../06-Luoghi/06.4-altri-centri.md` → riferimento alla "Spedizione Adriatica"
   - `../06-Luoghi/06.4-altri-centri.md` → riferimento alla "Fiera delle Tecnologie"
   - `../07-Creature/07.2-palustres.md` → riferimento alla migrazione dei Palustres menzionata in `10.1-cronologia.md`
...
1. "Alessandra Morvillo" - figura chiave dei Custodi che meriterebbe una sezione dettagliata o un file dedicato
