...
- `../01.0-indice-principale.md` → sezione Vault
...
- "Figli del Silenzio" (compare 3 volte)
...
- "Figli del Silenzio" (compare 5 volte)
- "Custodi" (compare 3 volte)
...
- `../07-Creature/07.2-palustres.md` → origine dal Vault 186
...
- "Figli del Silenzio" (compare 6 volte)
...
- "Figli del Silenzio" (compare 27 volte)
- "Custodi" (compare 33 volte)
...
- "Figli del Silenzio" (compare 17 volte)
- "Custodi" (compare 24 volte)
...
- "Palustres" (compare 8 volte)
- "Palustres Luminosi" (compare 4 volte)
...
- "Alto Mare Dolce" (compare 1 volta)
...
- "Palustres" (compare 8 volte)
- "Palustres Luminosi" (compare 1 volta)
...
- "Doge Tecnico" / "Antonio Loredan" (fondatore della Repubblica di Venezia)
  - **Menzionato in**: `09.3-esperimenti-sociali.md`, `09.5-sopravvissuti-vault.md`, `../05-Fazioni/05.2-citta-stato-nord.md`, `../06-Luoghi/06.4-altri-centri.md`
  - **File principale**: `09.5-sopravvissuti-vault.md` (descrizione principale)
  - **Stato collegamenti**: Da implementare
...
- "Vault 186" (origine dei Palustres)
  - **Menzionato in**: `09.2-tipologie-vault.md`, `09.3-esperimenti-sociali.md`, `09.5-sopravvissuti-vault.md`, `../07-Creature/07.2-palustres.md`
  - **File principale**: `09.3-esperimenti-sociali.md` (descrizione dettagliata)
  - **Stato collegamenti**: Da implementare
...
- "Città Sottomarina"
  - **Menzionato in**: `09.6-rifugi-alternativi.md`, potenzialmente `../07-Creature/07.2-palustres.md`
  - **File principale**: `09.6-rifugi-alternativi.md` (descrizione principale)
  - **Stato collegamenti**: Da implementare
...
3. Da `../07-Creature/07.2-palustres.md` a `09.3-esperimenti-sociali.md#vault-186` per l'origine dei Palustres
...
2. **Interconnessione con le fazioni**:
   ...
   - La resistenza al condizionamento è alla base di alcune fazioni (Custodi)
