...
- `../01.0-indice-principale.md` → sezione Creature
- `07.1-mutazioni-panoramica.md` → riferimento alla panoramica delle creature
- `07.2-palustres.md` → riferimento alla panoramica delle creature
...
- `07.2-palustres.md` → riferimento alla panoramica delle mutazioni
...
- `../03-Geografia/03.3-regioni-nord.md#grande-palude` (Alto Mare Dolce)
- `../06-Luoghi/06.4-altri-centri.md` (Repubblica Serenissima di Venezia)
- `../05-Fazioni/05.3-lega-navigli.md` (Lega dei Navigli)

**Collegamenti in entrata**:
- `07.0-creature-panoramica.md` → riferimento ai Palustres come specie dominante
- `07.1-mutazioni-panoramica.md` → riferimento ai Palustres come esempio di mutazioni
- `07.3-lupi-roma.md` → riferimento ai Palustres come altre creature intelligenti
- `07.4-chimere.md` → riferimento ai Palustres come prede potenziali
- `07.5-altre-creature.md` → riferimento ai Palustres come specie principale
- `../05-Fazioni/05.0-fazioni-panoramica.md` → riferimento ai Palustres (senza collegamento)
- `../06-Luoghi/06.4-altri-centri.md` → riferimento ai Palustres come alleati

**Elementi chiave menzionati senza collegamenti**:
- "Alto Mare Dolce" (compare 23 volte)
...
- `07.2-palustres.md` → riferimento ai Lupi di Roma
...
- `07.2-palustres.md` → riferimento alle Chimere Acquatiche
...
### Creature Principali
- "Palustres"
  - **Menzionato in**: `07.0-creature-panoramica.md`, `07.1-mutazioni-panoramica.md`, `07.2-palustres.md`, `07.4-chimere.md`, `07.5-altre-creature.md`, `../05-Fazioni/05.0-fazioni-panoramica.md`, `../06-Luoghi/06.4-altri-centri.md`
  - **File principale**: `07.2-palustres.md` (descrizione completa)
  - **Stato collegamenti**: Completo nei file principali, manca in `../05-Fazioni/05.0-fazioni-panoramica.md`

- "Lupi di Roma"
  - **Menzionato in**: `07.0-creature-panoramica.md`, `07.1-mutazioni-panoramica.md`, `07.2-palustres.md`, `07.3-lupi-roma.md`, `07.5-altre-creature.md`, `../05-Fazioni/05.1-stato-pontificio.md`
  - **File principale**: `07.3-lupi-roma.md` (descrizione completa)
  - **Stato collegamenti**: Completo nei file principali

- "Chimere Acquatiche"
  - **Menzionato in**: `07.0-creature-panoramica.md`, `07.1-mutazioni-panoramica.md`, `07.2-palustres.md`, `07.3-lupi-roma.md`, `07.4-chimere.md`, `07.5-altre-creature.md`, `../03-Geografia/03.1-morfologia-generale.md`
...
- "Alto Mare Dolce"
  - **Menzionato in**: `07.0-creature-panoramica.md`, `07.1-mutazioni-panoramica.md`, `07.2-palustres.md`, `07.5-altre-creature.md`, `../03-Geografia/03.3-regioni-nord.md`
...
- "Repubblica Serenissima di Venezia"
  - **Menzionato in**: `07.2-palustres.md`, `07.4-chimere.md`, `../06-Luoghi/06.4-altri-centri.md`
  - **File principale**: `../06-Luoghi/06.4-altri-centri.md`
  - **Stato collegamenti**: Completo nei file principali
...
- "Crisi delle Acque Mutate (2287-2289)"
  - **Menzionato in**: `07.2-palustres.md`, `../10-Eventi/10.2-conflitti.md`
  - **File principale**: Nessuno - evento menzionato in più file
  - **Stato collegamenti**: Da implementare - necessita di riferimenti incrociati tra file
...
1. In `07.0-creature-panoramica.md`: Collegamenti a "Palustres", "Lupi di Roma" e "Chimere Acquatiche" 
2. In `07.1-mutazioni-panoramica.md`: Collegamenti a "Alto Mare Dolce", "Zona del Silenzio", "Custodi" e "Stato Pontificio"
3. In `07.2-palustres.md`: Collegamenti a "Custodi", "Fratellanza Alpina" e "Stato Pontificio"
4. In `07.3-lupi-roma.md`: Collegamenti a "Custodi" che dovrebbe puntare a `../05-Fazioni/05.6-custodi-tempo.md`
5. In `07.4-chimere.md`: Collegamenti a "Custodi" e principali fazioni menzionate
6. In `07.5-altre-creature.md`: Collegamenti a "Custodi", "Stato Pontificio" e "Alto Mare Dolce"

### Collegamenti bidirezionali da implementare
1. Collegamenti mancanti da `../05-Fazioni/05.0-fazioni-panoramica.md` a "Palustres" in `07.2-palustres.md`
