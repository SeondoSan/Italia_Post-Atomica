...
- `../01.0-indice-principale.md` → sezione [Nome Modulo]
...
- "Aeternus Primus" (compare 3 volte)
...
3. In `05.0-fazioni-panoramica.md`: Collegamento a "Palustres" che dovrebbe puntare a `../07-Creature/07.2-palustres.md`
