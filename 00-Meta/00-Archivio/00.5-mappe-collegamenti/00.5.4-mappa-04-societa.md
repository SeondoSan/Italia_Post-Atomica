...
- `../01.0-indice-principale.md` → sezione Società
- `04.1-demografia.md` → riferimento alla panoramica della societa
- `04.2-economia.md` → riferimento alla panoramica della societa
- `04.3-cultura.md` → riferimento alla panoramica della societa
- `04.4-nuova-religiosita.md` → riferimento alla panoramica della societa
- `04.5-memoria-collettiva.md` → riferimento alla panoramica della societa
...
- "Custodi" (compare 4 volte)
- "Palustres" (compare 7 volte)
- "Figli del Silenzio" (compare 7 volte)
...
- "Papa Aeternus Primus" (compare 1 volta)
- "Custodi" (compare 10 volte)
- "Palustres" (compare 1 volta)
...
- "Figli del Silenzio" (compare 14 volte)
- "Aeternus Primus" (compare 4 volte)
...
- "Aeternus Primus" (compare 2 volte)
...
1. In tutti i file del modulo 04: Collegamenti a "Custodi" che dovrebbero puntare a `../05-Fazioni/05.6-custodi-tempo.md`
...
2. **Stratificazione e profondità sociale**:
   - La societa post-apocalittica è presentata con diversi livelli di complessità
...
5. Approfondimento delle tensioni tra tradizionalisti e riformisti in diverse aree della societa