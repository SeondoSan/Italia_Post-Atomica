...
- `06.4-altri-centri.md` (Repubblica Serenissima di Venezia)
- `06.4-altri-centri.md` (Ducato di Milano)
...
- `06.4-altri-centri.md` → riferimento a relazioni con Parthenope Vaticana
- `06.4-altri-centri.md` → riferimento indiretto alle città-stato
...
- `../07-Creature/07.2-palustres.md` (Palustres)
...
- `06.4-altri-centri.md` → riferimento a relazioni con Repubblica Serenissima di Venezia
...
- `../07-Creature/07.2-palustres.md` → riferimento alle relazioni con Venezia
...
- `06.4-altri-centri.md` → riferimento a relazioni con Ducato di Milano
...
- `06.4-altri-centri.md` → riferimento ad altri centri urbani
...
- "Parthenope Vaticana"
  - **Menzionato in**: `06.0-luoghi-panoramica.md`, `06.1-parthenope.md`, `06.4-altri-centri.md`, `06.4-altri-centri.md`
...
- "Repubblica Serenissima di Venezia"
  - **Menzionato in**: `06.0-luoghi-panoramica.md`, `06.1-parthenope.md`, `06.4-altri-centri.md`, `06.4-altri-centri.md`, `06.4-altri-centri.md`, `06.5-terre-selvagge.md`
  - **File principale**: `06.4-altri-centri.md` (descrizione completa)
...
- "Torino Tecnologica"
  - **Menzionato in**: `06.4-altri-centri.md`, `06.4-altri-centri.md`
  - **File principale**: `06.4-altri-centri.md` (sezione dedicata)
  - **Stato collegamenti**: Da implementare - manca collegamento in `06.4-altri-centri.md`
...
- "Zona Alta/Zona Bassa/Zona di Mezzo" (Venezia)
  - **Menzionato in**: `06.4-altri-centri.md`
  - **File principale**: `06.4-altri-centri.md` (sezione Struttura urbana)
  - **Stato collegamenti**: Interno al file principale

### Personaggi/Entità Governative
- "Doge Alvise Barbarigo"
  - **Menzionato in**: `06.4-altri-centri.md`, `../10-Eventi/10.2-conflitti.md`
  - **File principale**: `06.4-altri-centri.md`
  - **Stato collegamenti**: Da implementare in `../10-Eventi/10.2-conflitti.md`

- "Duca Ludovico Visconti"
  - **Menzionato in**: `06.4-altri-centri.md`, `../10-Eventi/10.1-cronologia.md`
  - **File principale**: `06.4-altri-centri.md`
...
- "Ducato Venetico"
  - **Menzionato in**: `06.4-altri-centri.md`, `../04-Societa/04.2-economia.md`
  - **File principale**: Nessun file dedicato
  - **Stato collegamenti**: Da implementare - manca collegamento a `../04-Societa/04.2-economia.md`
...
1. In `06.5-terre-selvagge.md`: Collegamenti a "Custodi" che dovrebbero puntare a `../05-Fazioni/05.6-custodi-tempo.md`
2. In `06.5-terre-selvagge.md`: Collegamenti a "Repubblica Serenissima di Venezia" e "Ducato di Milano" che dovrebbero puntare rispettivamente a `06.4-altri-centri.md` e `06.4-altri-centri.md`
3. In `06.4-altri-centri.md`: Collegamenti a "Custodi" che dovrebbero puntare a `../05-Fazioni/05.6-custodi-tempo.md`
4. In `06.1-parthenope.md`, `06.4-altri-centri.md`, `06.4-altri-centri.md`: Collegamenti alle valute menzionate che dovrebbero puntare a `../04-Societa/04.2-economia.md`
...
2. Da `../05-Fazioni/05.2-citta-stato-nord.md` a `06.4-altri-centri.md` e `06.4-altri-centri.md` per descrizioni dettagliate delle città principali
3. Da `../05-Fazioni/05.3-lega-navigli.md` a `06.4-altri-centri.md` e `06.4-altri-centri.md` per riferimenti alle relazioni commerciali
4. Da `../07-Creature/07.2-palustres.md` a `06.4-altri-centri.md` per dettagli sulla città dove hanno maggior presenza
5. Da `../10-Eventi/10.2-conflitti.md` a `06.4-altri-centri.md` e `06.4-altri-centri.md` per il conflitto menzionato del 2287
